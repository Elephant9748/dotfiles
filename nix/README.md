...
> [!NOTE]
>
> !if using limine as bootloader make sure efi and boot partition in fat32
...
### Generate nixos config (!after mount drive)
...
git clone <repo url>
nixos-install --flake .#<machine/host> --verbose
reboot
```
