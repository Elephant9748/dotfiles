...
/+ Arch Linux
        ...
        // UUID PATH
                protocol: linux
                path: uuid(PARTUUID):/vmlinuz-linux
                cmdline: rd.luks.name=DEVICES-UUID=Luks-ed6662cd root=/dev/vg_arch/lv_root randomize_kstack_offset=on vsyscall=none loglevel=3 quiet splash
                module_path: uuid(PARTUUID):/initramfs-linux.img
